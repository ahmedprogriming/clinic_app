    ...
    return BlocConsumer<EditPatientCubit, EditPatientState>(
      listener: (context, state) {
        ...
        if (state is EditPatientSuccess) {
          showSnackbar(context, 'تم التعديل المريض بنجاح',type: SnackBarType.success);
         ...
         if (state is EditPatientDeletedSuccess) {
          showSnackbar(context, 'تم حذف المريض بنجاح', type: SnackBarType.success);
                              ...
                              onPressed: isLoading
                                  ...
                                  : () {
                                      ...
                                      if (name.isEmpty ||
                                        ...
                                        showSnackbar(
                                          context,
                                          'يرجى ملء جميع الحقول', type: SnackBarType.warning
                                        );
