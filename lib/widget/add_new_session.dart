    ...
    return BlocConsumer<AddSessionCubit, AddSessionState>(
      listener: (context, state) {
        ...
        if (state is AddSessionSuccess) {
          showSnackbar(context, 'تمت إضافة الجلسة بنجاح', type: SnackBarType.success);
      ...
      builder: (context, state) {
        ...
        return Directionality(
          ...
          child: AbsorbPointer(
            ...
            child: Opacity(
             opacity: isReadOnly ? 0.7 : 1.0, // ✅ صحيح
              child: ListView(
                children: [
                            ...
                            children: [
                              Expanded(
                                child: CustomSelectedElement(
                                  ...
                                  onTap: () {
                                    context
                                        .read<AddSessionCubit>()
                                        .changeSessionType('تدليك');
                                  },
                                ),
                              ),
                              ...
                              Expanded(
                                child: CustomSelectedElement(
                                  ...
                                  onTap: () {
                                    context
                                        .read<AddSessionCubit>()
                                        .changeSessionType('حجامة و تدليك');
                                  },
                                ),
                              ),
                            ],
                          ...
                          onPressed: isLoading
                              ...
                              : () {
                                  ...
                                  if (name.isEmpty ||
                                    ...
                                    showSnackbar(
                                      context,
                                      'يرجى ملء جميع الحقول المطلوبة واختيار النوع والحالة', type: SnackBarType.warning
                                    );
